...
@property (nonatomic, strong) AVURLAsset *avUrlAssetAlpha;
@property (nonatomic, strong) AVAssetReader *aVAssetReaderAlpha;
@property (nonatomic) BOOL worked;
@property (nonatomic, strong) AVAssetReaderTrackOutput *outputAlpha;
